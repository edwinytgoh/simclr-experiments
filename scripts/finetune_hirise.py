...
txt_file = "train-set-10pct-5105imgs.txt"
# find Google's simclr weights in simclr_weights_dir/r50_2x_sk0/saved_model; see L.79
...
class_mapping = read_class_label_map(
    os.path.join(data_dir, "landmarks_map-proj-v3_2_classmap.csv")
)
...
cls = [classes[l] for l in sorted(set(labels))]
num_examples = [
